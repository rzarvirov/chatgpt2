...
const sentences = [
  ...
  'Ответь на письмо от начальника: <вставь переписку письмо>',
  ...
  'Напиши функцию на Python для расчета факториала заданного числа?',
  'Как профессиональный переводчик переведи юридический документ с английского на французский язык: <вставь текст>',
  'Сможешь ли объяснить концепцию квантовой механики простыми словами?',
  'Каковы преимущества и недостатки использования возобновляемых источников энергии?',
  'Объясни основы и применения искусственного интеллекта',
  'Выдай обзор истории и культурного значения хип-хоп музыки',
  'У меня в холодильнике: картошка, йогурт, колбаса, помидор. Что приготовить?',
  'Напиши скрипт для продажи ДНК-теста для определения диеты',
  'Помоги мне написать короткую историю о путешественнике во времени, который случайно попадает в 1900 год?',
  'Какие есть натуральные средства от бессонницы?',
  'Порекомендуй хорошие книги или фильмы для просмотра любителю готовить?',
  'Какие развивающиеся технологии будут формировать будущее нашего общества?',
  'Какие есть места в Казахстане, которые стоит посетить, но которые не являются избитыми туристическими маршрутами?',
  'Можешь ли вы объяснить концепцию когнитивного диссонанса и как он влияет на наше поведение?',
  'Притворись психологом а я буду твоим пациентом. Задавай вопросы, затем давай короткие комментарии к моим ответам, чтобы направить меня к решению моей проблемы',
  'Чтобы подать заявку на работу, я хочу написать сопроводительное письмо. Пожалуйста, составь сопроводительное письмо на основе моего опыта: <вставьте резюме>',
