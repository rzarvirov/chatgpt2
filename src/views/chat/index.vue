...
function handleRecharge() {
  ...
  dialog.warning({
    ...
    content: 'Автоматическое пополнение временно недоступно. Поддержите проект на любую сумму и мы поплним ваш баланс. Текущая средняя стоимость запроса к gpt-4: 0.1$ за сообщение. Возможность выбирать модель для использования (включая гораздо более доступную gpt-3.5) появится в следующем релизе. Не забудьте указать ваш e-mail в комментарии к переводу. Хотите поддержать?',
