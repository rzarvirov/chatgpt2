...
function handleRecharge() {
  ...
  dialog.warning({
    ...
    content: 'Автоматическое пополнение временно недоступно. Поддержите проект на любую сумму и мы поплним ваш баланс. Просто укажите ваш e-mail в комментарии. Хотите поддержать?',
