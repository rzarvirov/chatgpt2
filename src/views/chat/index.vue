...
function handleRecharge() {
  ...
  dialog.warning({
    ...
    content: 'Автоматическое пополнение временно недоступно. Поддержите проект и мы поплним ваш баланс для продолжения использования. Просто укажите ваш e-mail в комментарии. Хотите поддержать?',
